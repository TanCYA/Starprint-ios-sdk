...
//      case SectionIndexDevice :
        ...
        case SectionIndexPrinter :
            alertView = [[UIAlertView alloc] initWithTitle:@"Select language."
                                         ...
                                         otherButtonTitles:@"English", @"Japanese", @"French", @"Portuguese", @"Spanish", @"Russian", @"Simplified Chinese", @"Traditional Chinese", nil];
        ...
        case SectionIndexAllReceipts :
            alertView = [[UIAlertView alloc] initWithTitle:@"Select language."
                                         ...
                                         cancelButtonTitle:@"Cancel"
//                                       otherButtonTitles:@"English", @"Japanese", @"French", @"Portuguese", @"Spanish", @"Russian", @"Simplified Chinese", @"Traditional Chinese", nil];
                                         otherButtonTitles:@"English", @"Japanese", @"French", @"Portuguese", @"Spanish",                                                            nil];
