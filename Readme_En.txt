...
=============
  ...
  This package contains StarPRNT SDK Ver 5.0.0.
...
=============
  ...
  +- Software
     +- Distributables
     |   |- StarIO.framework                  // StarIO.framework (Ver 2.3.0)
     |   |- StarIO_Extension.framework        // StarIO_Extension.framework (Ver 1.3.0)
     |   +- SMCloudServices.framework         // SMCloudServices.framework (Ver 1.2.0)
     |
     +- StarPRNT SDK
         |- IOS SDK                         // Samples (Ver 3.16.0)
         |- ObjectiveC SDK                  // Samples (Ver 5.0.0)
         |- Swift SDK                       // Samples (Ver 5.0.0)
